    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.results.update", [$result->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_points') ? 'is-invalid' : '' }}" type="number" name="total_points" id="total_points" value="{{ old('total_points', $result->total_points) }}" step="1">
